...
def download_yt():
    ...
    try:
        ...
        res_options = [stream.resolution for stream in video_streams]
        print(res_options)
...
if radio_var == 2:
    res_label = ctk.CTkLabel(app, text='Escolha a resolução (vídeo):')
    res_label.pack(pady=5)


    res_var = tk.StringVar()
    res_combobox = ctk.CTkComboBox(radio_frame, variable=res_var, values=["360p", "480p", "720p", "1080p"])
    res_combobox.set("720p")  # valor padrão
